...
namespace JPEG
{
    ...
    std::vector<unsigned char> encode_greyscale_image(const Array_2d<double>& array_2d, int qf=50, bool optimize_huff=true);
    ...
    std::vector<unsigned char> encode_colour_image(
        ...
        bool optimize_huff=true, Subsampling ss=Subsampling::ss_4_4_4
    );
}
